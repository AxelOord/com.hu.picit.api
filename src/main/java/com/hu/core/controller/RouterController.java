...
import main.java.com.hu.core.service.ControllerService;
...
public class RouterController implements HttpHandler {
    ...
    public void registerRoutesFromPackage() {
        try {
            ...
            List<Class<?>> controllers = ControllerService.findControllers("main.java.com.hu.picit.api.controller"); // the picit.api.controllers should be set in the api main class
